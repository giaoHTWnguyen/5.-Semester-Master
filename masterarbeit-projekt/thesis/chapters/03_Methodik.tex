...
Faktische Fragen besitzen einen eindeutig bestimmbaren Referenzwerte, etwa einen Mittelwert, einen Median, eine Kündigungsquote oder einen Korrelationskoeffizienten. Ihre Bewertung beruht auf dem numerischen Vergleich zwischen dem in der Antwort genannten und dem berechneten Wert. Da eine sprachlich formulierte Antwort selten exakt mit dem Referenzwert übereinstimmt und Rundungen sowie unterschiedliche Nachkommastellen zu erwarten sind, wird die Übereinstimmung nicht als exakte Gleichheit, sondern über Toleranzbänder bestimmt. Ein enges Toleranzband kennzeichnet eine Abweichung, die sich allein durch Rundung ergibt und die inhaltliche Korrektheit nicht berührt. Ein weites Toleranzband umfasst Abweichungen, die über die Rundungen hinausgehen, die Größenordnung und die Richtung der Aussage jedoch unberührt lassen. Die Breite der Bänder richtet sich nach dem Typ der Kennzahl und ist in folgender Tabelle~ref{tab:toleranz} zusammengefasst.

% TODO: Die Breiten der Toleranzbänder mit den fixierten Referenzwerten abgleichen und bei Bedarf anpassen.
\begin{table}[htbp]
    \centering
    \small
    \caption[Toleranzbänder für faktische Fragen]{Toleranzbänder für die Bewertung faktischer Fragen nach Kennzahltyp. Die angegebenen Breiten sind als vorläufige Festlegung zu verstehen und werden vor der Auswertung anhand der berechneten Referenzwerte überprüft.}
    \label{tab:toleranz}
    \begin{tabular}{p{4.3cm} p{4.3cm} p{4.3cm}}
        \hline
        \textbf{Kennzahltyp} & \textbf{Enges Band (3 Punkte)} & \textbf{Weites Band (2 Punkte)} \\
        \hline
        Lagemaße (Mittelwert, Median) & relative Abweichung bis 1\,\% & relative Abweichung bis 5\,\% \\
        Anteile und Quoten & bis 0,5 Prozentpunkte & bis 2 Prozentpunkte \\
        Korrelationskoeffizient & bis 0,02 & bis 0,05 \\
        Zählwerte (Anzahl) & exakte Übereinstimmung & Abweichung um einen Wert \\
        \hline
    \end{tabular}
\end{table}
