...
Um die Antworten der Modelle bewerten zu können, wird für jede Analysefrage ein Referenzwert benötigt, der den korrekt Sollzustand abbildet. Diese Referenzwerte werden auf der bereinigten Fassung des Datensatzes berechnet und dienen als Vergleichsmaßstab, gegen den die Modellausgaben geprüft werden Berechnet werden deskriptive Kennzahlen, Zusammenhänge sowie Merkmalskombinationen, die mit der Zielvariable einhergehen.
