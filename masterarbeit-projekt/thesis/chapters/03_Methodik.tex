...
Die beiden Anbieter unterscheiden sich in der technischen Bereitstellung des wiederverwendeten Kontexts: Bei OpenAI erfolgt das Prompt-Caching automatisch als Präfix-Cache, bei Google über einen explizit angelegten Kontext-Cache. Dessen Lebensdauer wurde bei längeren Läufen erhöht, da ein vorzeitiges Ablaufen sonst zu einem Fehler wegen eines nicht mehr verfügbaren Caches während des Laufs führte. Inhaltlich stand beiden Modellen bei jeder Anfrage derselbe vollständige Datensatz zur Verfügung.
