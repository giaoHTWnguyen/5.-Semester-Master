...
\begin{description}
    ...
    \item[FF3] Welchen Einfluss hat die iterative Mensch-\gls{llm}-Interaktion auf die Konsistenz und Qualität der Analyseergebnisse?
    \item[FF4] Über welches methodische Vorgehen zur explorativen Datenanalyse verfügen \glspl{llm}?  
\end{description}
